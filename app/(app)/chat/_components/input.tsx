...
const ChatInput: React.FC = () => {
  ...
  return (
    <form
      ...
      className={cn(
        // Base styles
        'w-full rounded-[48px] flex flex-col overflow-hidden transition-colors duration-200 ease-in-out border-[1px] border-[#1145704d] dark:border-[#ffffff24] shadow-none max-w-[1100px]',
        // Light mode styles
