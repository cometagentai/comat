                        ...
                        <div className="flex flex-col gap-2 overflow-hidden">
                            {
                                topPair.info.websites?.map((website) => (
                                    <Link 
                                        href={website.url} 
                                        target="_blank" 
                                        className="text-sm text-sidebar-active hover:text-primary truncate" 
                                        key={website.url}
                                    >
                        ...
                        <div className="flex flex-col gap-2">
                            {
                                topPair.info.socials?.map((social) => (
                                    ...
                                    >
                                        {social.type[0].toUpperCase() + social.type.slice(1)}: <Link href={social.url} target="_blank" className="text-sidebar-active hover:text-primary">{social.url.split("/").pop()}</Link>
                                    </p>
                                ))
                            }
                        </div>
