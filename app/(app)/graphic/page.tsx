      ...
      <div className='flex size-full flex-col max-w-lg max-h-[200px] items-stretch justify-between gap-10'>
        ...
        <div className='flex flex-row items-center justify-between'>
          <Circle ref={div2Ref}>
            ...
            <p className='text-sm font-bold'>Trading</p>
          </Circle>
          <Circle
            ref={div4Ref}
            className='size-28 border-[#2a99f4] dark:border-[#2a99f4]'
          >
            <Logo className='size-20' />
          </Circle>
          <Circle ref={div6Ref}>
            <Droplet className='size-8' />
            <p className='text-sm font-bold'>Liquidity</p>
          </Circle>
        </div>
        <div className='flex flex-row items-center justify-between'>
          <Circle ref={div3Ref}>
            <Beef className='size-8' />
            <p className='text-sm font-bold'>Staking</p>
          </Circle>
          <Circle ref={div7Ref}>
            <Brain className='size-8' />
            <p className='text-sm font-bold'>Knowledge</p>
          </Circle>
        </div>
      </div>
